...
from ImageObjectDetectors.TensorflowResNet import NUM_RESNET_BLOCKS_PER_FILTER_SIZE, TensorflowResNet
from sklearn.metrics import accuracy_score
from ClassifierTestUtils import show_tensorflow_history
...
NUM_RESNET_FILTER_BLOCKS = 1  # More than 1 results in nan loss (???)
NUM_RESNET_BLOCKS_PER_FILTER_SIZE = 5  # Have tried 5, 7, 10
...
jet_recognizer = TensorflowResNet(INPUT_SHAPE,
                                  N_OUTPUT,
                                  LEARNING_RATE,
                                  ...
                                  n_resnet_filter_blocks=NUM_RESNET_FILTER_BLOCKS,
